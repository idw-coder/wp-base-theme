        ...
        <div class="px-4 md:px-8 py-8 md:py-12">
            <section class="section">
                ...
                <div class="white-box">
                    ...
                    <p class="text-center mb-8">営業時間9:00〜18:00（サービス提供時間9:30〜17:30）</p>
            ...
            <section class="section">
                ...
                <div class="white-box text-center">
                    <div class="max-w-[60%] mx-auto border-2 border-gray-200 pb-8 mb-8">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/map.png" alt="アクセスマップ" class="w-full h-auto">
                    </div>
                    <p class="mb-12">〒947-0102 新潟県小千谷市高梨町１９３１</p>
                    <div class="mb-8 max-w-[60%] mx-auto">
                    ...
                    <div class="max-w-[60%] mx-auto aspect-[3/1] rounded-lg overflow-hidden">
