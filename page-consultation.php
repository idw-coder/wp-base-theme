        ...
        <div class="px-4 md:px-8 py-8 md:py-12">
            ...
            <section class="section mb-12">
                <div class="white-box">
                    ...
                    <p class="mb-8">「障害児通所支援（児童発達支援・放課後等デイサービス等）」（児童）や「就労支援や自立訓練等の障害福祉サービス」（成人）を利用する際には、原則として相談支援事業所が作成するサービス利用計画が必要です。</p>

                    <p class="mb-8">障がいのあるご本人やそのご家族に相談支援専門員がお会いし、必要としている支援や保護者のニーズ等をうかがいます。そのうえで必要な支援の内容や量などを検討し、「サービス等利用計画」「障害児支援利用計画」を作成します。</p>
                    <p class="mb-8">また、計画を作成した後も、サービスの提供状況や利用者さまのニーズを確認（モニタリング）し、成長や環境の変化に合わせて、計画の見直しを行います。</p>
            ...
            <section class="section mb-12">
                ...
                <div class="white-box !px-4 md:!px-8 !py-20 md:!py-24">
                    <div class="flow-chart max-w-xl mx-auto">
                        ...
                        <div class="relative p-4 bg-sky1 rounded-lg border-2 border-blue1 shadow-md flex gap-4 items-center">
                            ...
                            <div class="flex-shrink-0 w-16 h-16 md:w-20 md:h-20 rounded-full bg-white flex items-center justify-center">
